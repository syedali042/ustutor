...
<head>
  ...
  <link href="<?=ADMINCSS?>sb-admin-2.min.css" rel="stylesheet">
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" action="javascript">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" id="email" aria-describedby="emailHelp" placeholder="Enter Username">
                    </div>
                    <div class="form-group">
                    ...
                    <a href="javascript://" class="btn btn-primary btn-user btn-block adminLogin">
                      Login
                    </a>
                    <hr>
