...
{
	$password = "";
	$possible = "";
...
function get_package_details($red)
{
	if(intval($red) === 1)
	{
		return array("detail"=>"12 Months subscription to Leading People : ", "total"=>"104","amount"=>104);
	}
	else if(intval($red) === 2)
	{
		return array("detail"=>"24 Months subscription to Leading People : ", "total"=>"182", "amount"=>182);
	}
	else if(intval($red) === 3)
	{
		return array("detail"=>"36 Months subscription to Leading People : ", "total"=>"234", "amount"=>234);
	}
