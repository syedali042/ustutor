...
include("ezsql_core.php");
	...
	if ( ! class_exists ('LB_ezSQL_core') ) die('<b>Fatal Error:</b> ezSQL_mysql requires LB_ezSQL_core (ez_sql_core.php) to be included/loaded before it can be used');

	class LB_ezSQL_mysql extends LB_ezSQL_core
	{
